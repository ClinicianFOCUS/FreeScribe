...
class MainWindow:
    ...
    def start_LLM_container(self, widget_name, app_settings):
        ...
        """
        try:
            self.container_manager.set_status_icon_color(
                widget_name, self.container_manager.start_container(
            ...
            tk.messagebox.showerror(
                "Error", f"An error occurred while starting the LLM container: {e}")
    ...
    def stop_LLM_container(self, widget_name, app_settings):
        ...
        try:
            self.container_manager.set_status_icon_color(
                widget_name, self.container_manager.stop_container(
                    app_settings.editable_settings["LLM Container Name"]))
            self.container_manager.set_status_icon_color(
                widget_name, self.container_manager.stop_container(
                    app_settings.editable_settings["LLM Caddy Container Name"]))
            ...
            tk.messagebox.showerror(
                "Error", f"An error occurred while stopping the LLM container: {e}")
    ...
    def start_whisper_container(self, widget_name, app_settings):
        ...
        try:
            ...
            tk.messagebox.showerror(
                "Error", f"An error occurred while starting the Whisper container: {e}")
    ...
    def stop_whisper_container(self, widget_name, app_settings):
        ...
        try:
            ...
            tk.messagebox.showerror(
                "Error", f"An error occurred while stopping the Whisper container: {e}")
